...
import os
while True:
    print('\nPress *1* to load INDICES\n\nPress *2* to select SCRIP(s)\n\n')
    in1= int(input('>>> '))
    ...
    if in1==1:
        ...
        for SCRIP in scrip_List:
            ...
            try:
                ...
                try:
                    ...
                    z1= round((z*100),2)
                    z2= round((z*100*math.sqrt(22)),2)
                    z3= round((z*100*math.sqrt(256)),2)
                    ltp1=data1[0]
                    ltp2=data1[mx-2]
        ...
        data_Vol= int(input('How many SCRIP(s)? >>> '))
        vol= data_Vol+1
        url='https://www.nseindia.com'
        scrip_List=[]
        for i in range(1,vol,+1):
            new_Scrip = input('SCRIP#'+str(i)+': ')
            scrip_List.append(new_Scrip)
